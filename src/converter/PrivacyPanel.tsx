...
function PrivacyGerman() {
  return (
    <div className="flex flex-col overflow-auto p-2 text-sm">
      <H3>Datenschutzerklärung</H3>

      <p>
        Wir freuen uns sehr über Ihr Interesse. Datenschutz hat einen besonders
        hohen Stellenwert für die Geschäftsleitung bei der Stepan Rutz Software
        Engineering. Eine Nutzung der Internetseiten der Stepan Rutz Software
        Engineering ist grundsätzlich ohne jede Angabe personenbezogener Daten
      ...
      <p>
        ...
        Übereinstimmung mit den für die Stepan Rutz Software Engineering
      ...
      <p>
        Die Stepan Rutz Software Engineering hat als für die Verarbeitung
      ...
      <p>
        Die Datenschutzerklärung der Stepan Rutz Software Engineering beruht auf
      ...
      <p>Stepan Rutz Software Engineering</p>
      <p>Brunnenallee 25a</p>
      <p>50226 Frechen</p>
      <p>Germany</p>
      <p>Tel.: 015780433749</p>
      <p>E-Mail: stepan.rutz@gmx.de</p>
      <p>Website: https://www.erechnungstool.com</p>

      <h4>3. Cookies</h4>
      <p>
        Die Internetseiten der Stepan Rutz Software Engineering verwenden
      ...
      <p>
        Durch den Einsatz von Cookies kann die Stepan Rutz Software Engineering
      ...
      <p>
        Die Internetseite der Stepan Rutz Software Engineering erfasst mit jedem
      ...
      <p>
        ...
        Stepan Rutz Software Engineering keine Rückschlüsse auf die betroffene
        ...
        erhobenen Daten und Informationen werden durch die Stepan Rutz Software
        Engineering daher einerseits statistisch und ferner mit dem Ziel
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            Person die Löschung von personenbezogenen Daten, die bei der Stepan
            Rutz Software Engineering gespeichert sind, veranlassen möchte, kann
            sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Stepan
            Rutz Software Engineering wird veranlassen, dass dem Löschverlangen
            unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Stepan Rutz Software
            Engineering öffentlich gemacht und ist unser Unternehmen als
            Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
            personenbezogenen Daten verpflichtet, so trifft die Stepan Rutz
            Software Engineering unter Berücksichtigung der verfügbaren
            ...
            Mitarbeiter der Stepan Rutz Software Engineering wird im Einzelfall
        ...
        <li>
          ...
          <p>
            ...
            bei der Stepan Rutz Software Engineering gespeichert sind, verlangen
            möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für
            die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Stepan
            Rutz Software Engineering wird die Einschränkung der Verarbeitung
            veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Stepan Rutz
            Software Engineering wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Stepan Rutz Software Engineering verarbeitet die
          ...
          <p>
            Verarbeitet die Stepan Rutz Software Engineering personenbezogene
            ...
            Person gegenüber der Stepan Rutz Software Engineering der
            Verarbeitung für Zwecke der Direktwerbung, so wird die Stepan Rutz
            Software Engineering die personenbezogenen Daten nicht mehr für
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Stepan Rutz
            Software Engineering zu wissenschaftlichen oder historischen
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Stepan Rutz Software
            Engineering oder einen anderen Mitarbeiter wenden. Der betroffenen
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Stepan Rutz Software Engineering
...
function PrivacyEnglish() {
  return (
    <div className="flex flex-col overflow-auto p-2 text-sm">
      ...
      <p>
        We are very pleased about your interest. Data protection has a
        particularly high priority for the management of Stepan Rutz Software
        Engineering. The use of the websites of Stepan Rutz Software Engineering
        is generally possible without providing any personal data. However, if a
        data subject wants to use special services of our company via our
        website, processing of personal data may become necessary. If the
        processing of personal data is required and there is no legal basis for
      ...
      <p>
        ...
        Stepan Rutz Software Engineering. Through this privacy policy, our
        company would like to inform the public about the type, scope and
        purpose of the personal data we collect, use and process. Furthermore,
        data subjects are informed about their rights through this privacy
        policy.
      </p>

      <p>
        Stepan Rutz Software Engineering, as the controller, has implemented
        numerous technical and organizational measures to ensure the most
        complete protection possible of the personal data processed via this
        website. Nevertheless, internet-based data transmissions can generally
        have security vulnerabilities, so that absolute protection cannot be
      ...
      <h4>1. Definitions</h4>
      <p>
        The privacy policy of Stepan Rutz Software Engineering is based on the
        terms used by the European legislator for the adoption of the General
        Data Protection Regulation (GDPR). Our privacy policy should be legible
      ...
      <p>In this privacy policy, we use, inter alia, the following terms:</p>
      ...
      <p>50226 Frechen</p>
      <p>Germany</p>
      <p>Phone: 015780433749</p>
      <p>Email: stepan.rutz@gmx.de</p>
      <p>Website: https://www.erechnungstool.com</p>

      <h4>3. Cookies</h4>
      <p>
        The Internet pages of Stepan Rutz Software Engineering use cookies.
        Cookies are text files that are stored and saved on a computer system
      ...
      <p>
        Through the use of cookies, Stepan Rutz Software Engineering can provide
      ...
      <p>
        The website of Stepan Rutz Software Engineering collects a series of
      ...
      <p>
        When using these general data and information, Stepan Rutz Software
        ...
        prosecution in case of a cyber-attack. Therefore, Stepan Rutz Software
        Engineering analyzes anonymously collected data and information
      ...
      <p>
        ...
        by the Internet service provider (ISP) and used by the data subject,
        date, and time of the registration are also stored. The storage of this
        data takes place against the background that this is the only way to
        prevent the misuse of our services, and, if necessary, to make it
      ...
      <p>
        ...
        other legislators in laws or regulations which the controller is subject
        to.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            information. Furthermore, the European legislator has granted the
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by Stepan Rutz
            Software Engineering, he or she may, at any time, contact any
            employee of the controller. An employee of Stepan Rutz Software
            Engineering shall promptly ensure that the erasure request is
          ...
          <p>
            ...
            as processing is not required. An employee of Stepan Rutz Software
            Engineering will arrange the necessary measures in individual cases.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            stored by Stepan Rutz Software Engineering, he or she may at any
            time contact any employee of the controller. The employee of Stepan
            Rutz Software Engineering will arrange the restriction of the
            processing.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            may at any time contact any employee of Stepan Rutz Software
            Engineering.
          </p>
        </li>
        <li>
          ...
          <p>
            Stepan Rutz Software Engineering shall no longer process the
          ...
          <p>
            If Stepan Rutz Software Engineering processes personal data for
            ...
            to Stepan Rutz Software Engineering to the processing for direct
            marketing purposes, Stepan Rutz Software Engineering will no longer
          ...
          <p>
            ...
            data concerning him or her by Stepan Rutz Software Engineering for
          ...
          <p>
            ...
            contact any employee of Stepan Rutz Software Engineering. In
        ...
        <li>
          ...
          <p>
            ...
            her, as long as the decision (1) is not necessary for entering into,
            or the performance of, a contract between the data subject and a
            data controller, or (2) is not authorised by Union or Member State
          ...
          <p>
            ...
            consent, Stepan Rutz Software Engineering shall implement suitable
          ...
          <p>
            ...
            contact any employee of Stepan Rutz Software Engineering.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            consent, he or she may, at any time, contact any employee of Stepan
            Rutz Software Engineering.
          </p>
        </li>
      </ul>
      ...
      <p>
        ...
        This would be the case, for example, if a visitor were injured at our
      ...
      <p>
        ...
        data subject, the data subject must contact any employee of our company.
      ...
      <p>
        ...
        <a
          ...
          className="anchor"
        >
          Media Law Lawyers from WBS.LEGAL
        </a>
        .
      </p>
    </div>
